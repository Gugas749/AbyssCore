...
/**
 * Fires every client tick. Checks if any AbyssCore keybind slot was pressed
 * and sends a KeyPressPacket to the server with the slot number.
 *
 * consumeClick() ensures each press is only counted once (handles key repeat correctly).
 */
